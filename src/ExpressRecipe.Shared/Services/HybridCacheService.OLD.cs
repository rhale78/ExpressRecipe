...
/// </summary>
public class HybridCacheServiceOld
{
    private readonly IMemoryCache _memoryCache;
    private readonly IDistributedCache _distributedCache;
    private readonly ILogger<HybridCacheServiceOld> _logger;
    ...
    public HybridCacheServiceOld(
        IMemoryCache memoryCache,
        IDistributedCache distributedCache,
        ILogger<HybridCacheServiceOld> logger)
    {
