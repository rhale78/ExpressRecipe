...
namespace ExpressRecipe.SafeForkService.Tests.Services.Gdpr;

public class HouseholdMemberSubscriberGdprTests
{
    private readonly Mock<IMessageBus> _bus;
    private readonly Mock<IAllergenProfileRepository> _repo;
    ...
    public HouseholdMemberSubscriberGdprTests()
    {
        ...
        _repo = new Mock<IAllergenProfileRepository>();
