    ...
    where TKey : notnull
{
    ...
    private bool IsExpired(CacheEntry<TEntity> entry)
    {
        ...
        return DateTime.UtcNow - entry.Timestamp > _expiration;
    }
    ...
    where TKey : notnull
{
        ...
        int promotionIntervalSeconds = 5)
    {
        ...
        _l1Cache = new Dictionary<TKey, CacheEntry<TEntity>>();
    ...
    private void PromoteL2ToL1(object? state)
    {
        ...
        try
        {
            ...
            Dictionary<TKey, CacheEntry<TEntity>> newL1 = new Dictionary<TKey, CacheEntry<TEntity>>();
