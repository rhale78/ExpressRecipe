            ...
            try
            {
                ...
                using (IDbCommand command = connection.CreateCommand())
                {
                    ...
                    int result = await ExecuteWithRetryAsync(
                        async () =>
                        {
                            return command is IDbCommandAsync asyncCommand
                                ? await asyncCommand.ExecuteNonQueryAsync(cancellationToken)
            ...
            try
            {
                ...
                using (IDbCommand command = connection.CreateCommand())
                {
                    ...
                    object? result = await ExecuteWithRetryAsync(
                        async () =>
                        {
                            return command is IDbCommandAsync asyncCommand ? await asyncCommand.ExecuteScalarAsync(cancellationToken) : command.ExecuteScalar();
                        },
                        cancellationToken);
