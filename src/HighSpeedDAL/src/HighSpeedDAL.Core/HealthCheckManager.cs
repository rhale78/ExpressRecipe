...
public sealed class HealthCheckManager : IDisposable
{
    ...
    public async Task<HealthCheckResult> CheckHealthAsync(CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            List<Task<HealthCheckEntry>> checkTasks = new List<Task<HealthCheckEntry>>();
...
public sealed class HealthCheckResult
{
    ...
    public List<HealthCheckEntry> Entries { get; set; } = new List<HealthCheckEntry>();
}
...
internal sealed class DatabaseConnectivityCheck : IHealthCheck
{
    ...
    {
        if (_connectionString.Contains("Data Source=:memory:", StringComparison.OrdinalIgnoreCase) ||
