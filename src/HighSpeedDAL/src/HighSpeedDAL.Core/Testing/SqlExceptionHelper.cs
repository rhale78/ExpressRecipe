    ...
    public static class SqlExceptionHelper
    {
        ...
        public static SqlException CreateSqlException(int errorNumber, string message = "Test SQL error")
        {
            try
            {
                ...
                FieldInfo? sqlErrorCollection = typeof(SqlException)
                ...
                // Create SqlError
                Type? sqlErrorType = typeof(SqlException).Assembly.GetType("Microsoft.Data.SqlClient.SqlError");
                ...
                ConstructorInfo? errorConstructor = sqlErrorType.GetConstructor(
                ...
                ConstructorInfo? collectionConstructor = sqlErrorCollection.FieldType!.GetConstructor(
                    BindingFlags.NonPublic | BindingFlags.Instance,
                    null,
                    Type.EmptyTypes,
                    null);
                ...
                MethodInfo? addMethod = sqlErrorCollection.FieldType!.GetMethod(
                    "Add",
                    BindingFlags.NonPublic | BindingFlags.Instance,
                    null,
                    new[] { sqlErrorType },
                ...
                SqlException exception = (SqlException)exceptionConstructor.Invoke(new object?[] { message, collection })!;
                return exception;
            }
            catch (Exception ex)
            {
