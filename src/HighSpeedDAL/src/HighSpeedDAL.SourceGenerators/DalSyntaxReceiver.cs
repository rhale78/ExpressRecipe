...
namespace HighSpeedDAL.SourceGenerators
{
    ...
    {
        public List<ClassDeclarationSyntax> EntityCandidates { get; } = [];
        public List<ClassDeclarationSyntax> ConnectionCandidates { get; } = [];
        public List<string> AllClassesFound { get; } = [];
