...
namespace ExpressRecipe.ProductService.Services
{
    ...
    public class LanguageDetector
    {
        ...
        public static bool IsEnglish(string text)
        {
            ...
            foreach (Regex pattern in CompiledNonEnglishPatterns)
            {
            ...
            return text.Length <= 20 || ((double)accentedCharCount / text.Length) <= 0.1;
        }
        ...
        public static bool ShouldImportProduct(string productName, string brand, string ingredients)
        {
            ...
            return string.IsNullOrWhiteSpace(ingredients) || IsEnglish(ingredients);
        }
