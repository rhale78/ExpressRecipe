...
public interface IProductRepository
{
    ...
    Task<int> CreateAsync(CreateProductRequest request, int? createdBy = null);
    Task<int> CreateProductAsync(CreateProductRequest request);
    Task<bool> UpdateAsync(int id, UpdateProductRequest request, int? updatedBy = null);
    Task<bool> DeleteAsync(int id, int? deletedBy = null);
    Task<bool> ApproveAsync(int id, bool approve, int approvedBy, string? rejectionReason = null);
    Task<bool> ProductExistsAsync(int id);
    Task AddIngredientToProductAsync(int productId, string ingredient, int orderIndex = 0);
    Task AddLabelToProductAsync(int productId, string label);
    Task AddAllergenToProductAsync(int productId, string allergen);
    Task AddExternalLinkAsync(int productId, string source, string externalId);
    Task UpdateProductMetadataAsync(int productId, string key, string value);
