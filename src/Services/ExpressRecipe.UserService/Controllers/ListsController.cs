    ...
    public class ListsController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<UserListDto>>> GetLists([FromQuery] string? listType = null)
        {
            try
            {
                ...
                List<UserListDto> lists = await _reportsRepository.GetUserListsAsync(userId.Value, listType);
                return Ok(lists);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<UserListDto>> GetList(Guid id, [FromQuery] bool includeItems = true)
        {
            try
            {
                UserListDto? list = await _reportsRepository.GetListByIdAsync(id, includeItems);
                ...
                if (list.UserId != userId)
                {
                    ...
                    List<UserListDto> sharedLists = await _reportsRepository.GetSharedListsAsync(userId!.Value);
        ...
        public async Task<ActionResult<Guid>> CreateList([FromBody] CreateUserListRequest request)
        {
            try
            {
                ...
                Guid listId = await _reportsRepository.CreateListAsync(userId.Value, request);
        ...
        public async Task<ActionResult> UpdateList(Guid id, [FromBody] UpdateUserListRequest request)
        {
            try
            {
                ...
                return !success ? NotFound(new { message = "List not found" }) : NoContent();
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<UserListItemDto>>> GetListItems(Guid id)
        {
            try
            {
                List<UserListItemDto> items = await _reportsRepository.GetListItemsAsync(id);
                return Ok(items);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<Guid>> AddListItem(Guid id, [FromBody] AddListItemRequest request)
        {
            try
            {
                ...
                Guid itemId = await _reportsRepository.AddListItemAsync(id, userId.Value, request);
        ...
        public async Task<ActionResult> UpdateListItem(Guid itemId, [FromBody] UpdateListItemRequest request)
        {
            try
            {
                ...
                return !success ? NotFound(new { message = "List item not found" }) : NoContent();
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<List<ListSharingDto>>> GetListSharing(Guid id)
        {
            try
            {
                List<ListSharingDto> sharing = await _reportsRepository.GetListSharingAsync(id);
                return Ok(sharing);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult<Guid>> ShareList(Guid id, [FromBody] ShareListRequest request)
        {
            try
            {
                ...
                Guid sharingId = await _reportsRepository.ShareListAsync(id, userId.Value, request);
        ...
        public async Task<ActionResult> UpdateListSharing(Guid sharingId, [FromBody] UpdateListSharingRequest request)
        {
            try
            {
                ...
                return !success ? NotFound(new { message = "List sharing not found" }) : NoContent();
            }
            catch (Exception ex)
            {
