...
namespace ExpressRecipe.UserService.Services
{
    ...
    public class PointsManagementService : BackgroundService
    {
        ...
        private async Task ProcessPointsTasksAsync(CancellationToken cancellationToken)
        {
            ...
            IPointsRepository pointsRepository = scope.ServiceProvider.GetRequiredService<IPointsRepository>();
            IActivityRepository activityRepository = scope.ServiceProvider.GetRequiredService<IActivityRepository>();
