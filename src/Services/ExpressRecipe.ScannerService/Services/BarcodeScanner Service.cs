    ...
    public class BarcodeScannerService
    {
        ...
        public async Task<ScanResult> ScanBarcodeAsync(string barcode, Guid? userId = null)
        {
            try
            {
                ...
                OpenFoodFactsProduct? offProduct = await _openFoodFactsClient.GetProductByBarcodeAsync(barcode);
                ...
                UPCDatabaseProduct? upcProduct = await _upcDatabaseClient.GetProductByBarcodeAsync(barcode);
            ...
            UPCDatabaseProduct upcProduct, string barcode)
        {
            ScannedProduct product = new ScannedProduct
            {
                ...
                Ingredients = [], // UPC Database doesn't provide ingredient info
        ...
        {
            return string.IsNullOrWhiteSpace(ingredientsText)
                ? []
                : ingredientsText
        ...
        {
            return allergenTags == null || allergenTags.Count == 0
                ? []
                : allergenTags
