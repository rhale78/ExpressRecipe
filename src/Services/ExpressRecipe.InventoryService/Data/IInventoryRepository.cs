...
public interface IInventoryRepository
{
    ...
    Task<Guid> AddInventoryItemAsync(Guid userId, Guid? productId, string? customName, Guid storageLocationId,
        decimal quantity, string? unit, DateTime? expirationDate, string? barcode, decimal? price = null, string? store = null);
    ...
    Task UpdateInventoryQuantityAsync(Guid itemId, decimal newQuantity, string actionType, string? reason);
