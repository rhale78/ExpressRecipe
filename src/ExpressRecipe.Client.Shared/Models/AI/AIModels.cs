namespace ExpressRecipe.Client.Shared.Models.AI
{
    ...
    {
        public string OriginalIngredient { get; set; } = string.Empty;
        public List<SubstitutionOptionDto> Substitutions { get; set; } = [];
    }
    ...
    public class ExtractedRecipeDto
    {
        ...
        public List<ExtractedIngredientDto> Ingredients { get; set; } = [];
        public List<string> Instructions { get; set; } = [];
        public List<string> DetectedAllergens { get; set; } = [];
        public string Difficulty { get; set; } = string.Empty;
    ...
    {
        public List<DayMealPlanDto> Days { get; set; } = [];
    ...
    {
        public List<DetectedAllergenDto> DetectedAllergens { get; set; } = [];
        public List<string> PotentialCrossContamination { get; set; } = [];
        public double ConfidenceScore { get; set; }
    }
    ...
    {
        public List<OptimizedShoppingItemDto> OptimizedList { get; set; } = [];
        public List<string> StoreRecommendations { get; set; } = [];
        public decimal EstimatedTotal { get; set; }
        public List<string> MoneyOptimizationTips { get; set; } = [];
    }
    ...
    public class DietaryAnalysisRequest
    {
        ...
        public List<string>? Ingredients { get; set; }
        public List<string> UserHealthGoals { get; set; } = [];
    ...
    public class DietaryAnalysisResult
    {
        ...
        public List<string> HealthConcerns { get; set; } = [];
        public List<string> NutritionHighlights { get; set; } = [];
