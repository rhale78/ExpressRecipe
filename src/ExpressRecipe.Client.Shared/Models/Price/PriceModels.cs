namespace ExpressRecipe.Client.Shared.Models.Price
{
    ...
    public class ProductPriceHistoryDto
    {
        ...
        public List<ProductPriceDto> PriceHistory { get; set; } = [];
        public List<StorePriceDto> PricesByStore { get; set; } = [];
    }
    ...
    public class BudgetAnalyticsDto
    {
        ...
        public List<StoreSpendingDto> SpendingByStore { get; set; } = [];
    }
    ...
    {
        public List<ProductComparisonDto> Products { get; set; } = [];
        public List<StoreTotalDto> StoreTotals { get; set; } = [];
    ...
    public class ProductComparisonDto
    {
        ...
        public string ProductName { get; set; } = string.Empty;
        public string Brand { get; set; } = string.Empty;
        public Dictionary<string, decimal> PricesByStore { get; set; } = [];
        public string BestStore { get; set; } = string.Empty;
