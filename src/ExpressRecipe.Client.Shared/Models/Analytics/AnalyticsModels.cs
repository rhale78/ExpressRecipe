namespace ExpressRecipe.Client.Shared.Models.Analytics
{
    ...
    public class SpendingReportDto
    {
        ...
        public List<SpendingDataPointDto> DataPoints { get; set; } = [];
    ...
    public class NutritionSummaryDto
    {
        ...
        public List<DailyNutritionDto> DailyBreakdown { get; set; } = [];
    }
    ...
    public class NutritionReportDto
    {
        ...
        public List<DailyNutritionDto> DailyData { get; set; } = [];
        public Dictionary<string, decimal> MacroBreakdown { get; set; } = [];
        public List<TopNutrientSourceDto> TopProteinSources { get; set; } = [];
        public List<TopNutrientSourceDto> TopFiberSources { get; set; } = [];
    }
    ...
    public class InventoryReportDto
    {
        ...
        public List<InventoryTrendDto> TrendData { get; set; } = [];
        public List<MostConsumedProductDto> MostConsumedProducts { get; set; } = [];
        public List<MostWastedProductDto> MostWastedProducts { get; set; } = [];
    }
    ...
    public class WasteSummaryDto
    {
        ...
        public List<WasteByCategoryDto> WasteByCategory { get; set; } = [];
        public List<WasteTrendDto> WasteTrend { get; set; } = [];
    }
    ...
    public class WasteReportDto
    {
        ...
        public List<WasteTrendDto> TrendData { get; set; } = [];
        public List<MostWastedProductDto> MostWastedProducts { get; set; } = [];
        public List<WasteByCategoryDto> WasteByCategory { get; set; } = [];
        public List<WasteReasonDto> WasteReasons { get; set; } = [];
    }
    ...
    public static class DateRangePresets
    {
        ...
        public static (DateTime Start, DateTime End) LastMonth
        {
            get
            {
                ...
                DateTime lastDayLastMonth = firstDayLastMonth.AddMonths(1).AddTicks(-1);
