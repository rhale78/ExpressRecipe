namespace ExpressRecipe.Client.Shared.Models.Inventory
{
    public class InventoryItemDto
    {
        ...
        public List<string> ProductAllergens { get; set; } = [];
        ...
        public List<string> Tags { get; set; } = []; // organic, gluten-free, local, etc.
    ...
    public class InventorySummaryDto
    {
        ...
        public Dictionary<string, int> ItemsByLocation { get; set; } = [];
