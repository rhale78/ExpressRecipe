namespace ExpressRecipe.Client.Shared.Models.MealPlanning
{
    ...
    public class MealPlanEntryDto
    {
        ...
        public List<string> RecipeAllergens { get; set; } = [];
        public List<string> RecipeDietaryInfo { get; set; } = [];
    ...
    {
        public DateTime Date { get; set; }
        public List<MealPlanEntryDto> Meals { get; set; } = [];
    ...
    public class MealPlanWeekView
    {
        ...
        public List<MealPlanDayDto> Days { get; set; } = []; // 7 days
    }
    ...
    public class QuickMealPlanRequest
    {
        ...
        public List<string> MealTypes { get; set; } = []; // Breakfast, Lunch, Dinner
