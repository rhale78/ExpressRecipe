...
namespace ExpressRecipe.Client.Shared.Services
{
    ...
    public class RecipeApiClient : ApiClientBase, IRecipeApiClient
    {
        ...
        {
            CreateRecipeResponse? response = await PostAsync<CreateRecipeRequest, CreateRecipeResponse>("/api/recipes", request);
        ...
        {
            FavoriteStatusResponse? result = await GetAsync<FavoriteStatusResponse>($"/api/recipes/{recipeId}/favorite");
        ...
        {
            ImportRecipeRequest request = new ImportRecipeRequest
            {
                Source = "File",
                Content = fileContent,
