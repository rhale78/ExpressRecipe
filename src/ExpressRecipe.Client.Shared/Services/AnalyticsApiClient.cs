...
namespace ExpressRecipe.Client.Shared.Services
{
    ...
    public class AnalyticsApiClient : IAnalyticsApiClient
    {
        ...
        public async Task<SpendingReportDto?> GetSpendingReportAsync(SpendingReportRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/analytics/spending/report", request);
        ...
        public async Task<NutritionReportDto?> GetNutritionReportAsync(NutritionReportRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/analytics/nutrition/report", request);
                response.EnsureSuccessStatusCode();
        ...
        public async Task<InventoryReportDto?> GetInventoryReportAsync(InventoryReportRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/analytics/inventory/report", request);
                response.EnsureSuccessStatusCode();
        ...
        public async Task<WasteReportDto?> GetWasteReportAsync(WasteReportRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/analytics/waste/report", request);
                response.EnsureSuccessStatusCode();
        ...
        public async Task<ExportReportResponse?> ExportReportAsync(ExportReportRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/analytics/export", request);
                response.EnsureSuccessStatusCode();
