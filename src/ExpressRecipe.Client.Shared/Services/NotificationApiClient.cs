...
namespace ExpressRecipe.Client.Shared.Services
{
    ...
    public class NotificationApiClient : INotificationApiClient
    {
        ...
        public async Task<NotificationSearchResult?> SearchNotificationsAsync(NotificationSearchRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/notifications/search", request);
        ...
        public async Task<bool> MarkAsReadAsync(Guid notificationId, bool isRead = true)
        {
            ...
            try
            {
                ...
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/notifications/mark-read", request);
        ...
        public async Task<bool> MarkAllAsReadAsync()
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsync("/api/notifications/mark-all-read", null);
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<bool> DeleteNotificationAsync(Guid id)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.DeleteAsync($"/api/notifications/{id}");
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<bool> DeleteAllReadAsync()
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.DeleteAsync("/api/notifications/delete-all-read");
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<bool> UpdatePreferencesAsync(UpdateNotificationPreferencesRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PutAsJsonAsync("/api/notifications/preferences", request);
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<bool> GenerateExpiringItemNotificationsAsync()
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsync("/api/notifications/generate-expiring", null);
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<bool> GenerateLowStockNotificationsAsync()
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsync("/api/notifications/generate-low-stock", null);
                return response.IsSuccessStatusCode;
            }
            catch
            {
