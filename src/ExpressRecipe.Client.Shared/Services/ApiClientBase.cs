...
namespace ExpressRecipe.Client.Shared.Services
{
    ...
    public abstract class ApiClientBase
    {
        ...
        protected async Task<TResponse?> PostAsync<TRequest, TResponse>(string endpoint, TRequest data)
        {
            ...
            try
            {
                HttpResponseMessage response = await HttpClient.PostAsJsonAsync(endpoint, data, JsonOptions);
        ...
        protected async Task<TResponse?> PutAsync<TRequest, TResponse>(string endpoint, TRequest data)
        {
            ...
            try
            {
                HttpResponseMessage response = await HttpClient.PutAsJsonAsync(endpoint, data, JsonOptions);
