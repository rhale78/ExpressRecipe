...
namespace ExpressRecipe.Client.Shared.Services
{
    ...
    public class MealPlanApiClient : IMealPlanApiClient
    {
        ...
        public async Task<MealPlanSearchResult?> SearchMealPlansAsync(MealPlanSearchRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/mealplan/search", request);
        ...
        public async Task<Guid?> CreateMealPlanAsync(CreateMealPlanRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/mealplan", request);
                response.EnsureSuccessStatusCode();
                CreateMealPlanResponse? result = await response.Content.ReadFromJsonAsync<CreateMealPlanResponse>();
                return result?.Id;
            }
            catch
            {
        ...
        public async Task<Guid?> CreateQuickMealPlanAsync(QuickMealPlanRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/mealplan/quick-plan", request);
                response.EnsureSuccessStatusCode();
                CreateMealPlanResponse? result = await response.Content.ReadFromJsonAsync<CreateMealPlanResponse>();
                return result?.Id;
            }
        ...
        public async Task<bool> UpdateMealPlanAsync(Guid id, UpdateMealPlanRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PutAsJsonAsync($"/api/mealplan/{id}", request);
        ...
        public async Task<bool> DeleteMealPlanAsync(Guid id)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.DeleteAsync($"/api/mealplan/{id}");
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<Guid?> AddMealEntryAsync(AddMealPlanEntryRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/mealplan/entries", request);
                response.EnsureSuccessStatusCode();
                AddMealEntryResponse? result = await response.Content.ReadFromJsonAsync<AddMealEntryResponse>();
        ...
        public async Task<bool> UpdateMealEntryAsync(Guid entryId, UpdateMealPlanEntryRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PutAsJsonAsync($"/api/mealplan/entries/{entryId}", request);
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<bool> DeleteMealEntryAsync(Guid entryId)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.DeleteAsync($"/api/mealplan/entries/{entryId}");
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<bool> MarkMealPreparedAsync(MarkMealPreparedRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/mealplan/entries/mark-prepared", request);
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<Guid?> GenerateShoppingListAsync(GenerateShoppingListFromMealPlanRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/mealplan/generate-shopping-list", request);
                response.EnsureSuccessStatusCode();
                GenerateShoppingListResponse? result = await response.Content.ReadFromJsonAsync<GenerateShoppingListResponse>();
        ...
        public async Task<bool> CompleteMealPlanAsync(Guid id)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsync($"/api/mealplan/{id}/complete", null);
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<bool> ArchiveMealPlanAsync(Guid id)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsync($"/api/mealplan/{id}/archive", null);
                return response.IsSuccessStatusCode;
            }
            catch
            {
