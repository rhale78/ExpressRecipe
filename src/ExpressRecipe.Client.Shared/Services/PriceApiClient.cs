...
namespace ExpressRecipe.Client.Shared.Services
{
    ...
    public class PriceApiClient : IPriceApiClient
    {
        ...
        public async Task<bool> RecordPriceAsync(RecordPriceRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/prices/record", request);
        ...
        public async Task<List<PriceAlertDto>> GetUserPriceAlertsAsync()
        {
            ...
            try
            {
                List<PriceAlertDto>? alerts = await _httpClient.GetFromJsonAsync<List<PriceAlertDto>>("/api/prices/alerts");
                return alerts ?? [];
            }
            catch
            {
        ...
        public async Task<bool> CreatePriceAlertAsync(CreatePriceAlertRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/prices/alerts", request);
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<bool> UpdatePriceAlertAsync(UpdatePriceAlertRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PutAsJsonAsync($"/api/prices/alerts/{request.AlertId}", request);
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<bool> DeletePriceAlertAsync(Guid alertId)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.DeleteAsync($"/api/prices/alerts/{alertId}");
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<List<ShoppingBudgetDto>> GetUserBudgetsAsync()
        {
            ...
            try
            {
                List<ShoppingBudgetDto>? budgets = await _httpClient.GetFromJsonAsync<List<ShoppingBudgetDto>>("/api/prices/budgets");
                return budgets ?? [];
            }
            catch
            {
        ...
        public async Task<Guid> CreateBudgetAsync(CreateShoppingBudgetRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/prices/budgets", request);
        ...
        public async Task<bool> UpdateBudgetAsync(UpdateShoppingBudgetRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PutAsJsonAsync($"/api/prices/budgets/{request.BudgetId}", request);
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<bool> DeleteBudgetAsync(Guid budgetId)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.DeleteAsync($"/api/prices/budgets/{budgetId}");
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<List<BudgetTransactionDto>> GetBudgetTransactionsAsync(Guid budgetId)
        {
            ...
            try
            {
                List<BudgetTransactionDto>? transactions = await _httpClient.GetFromJsonAsync<List<BudgetTransactionDto>>($"/api/prices/budgets/{budgetId}/transactions");
                return transactions ?? [];
            }
            catch
            {
        ...
        public async Task<bool> RecordTransactionAsync(RecordBudgetTransactionRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/prices/transactions", request);
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<bool> DeleteTransactionAsync(Guid transactionId)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.DeleteAsync($"/api/prices/transactions/{transactionId}");
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<PriceComparisonResult?> ComparePricesAsync(PriceComparisonRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/prices/compare", request);
                response.EnsureSuccessStatusCode();
        ...
        public async Task<List<BestPriceAlertDto>> GetBestPriceAlertsAsync()
        {
            ...
            try
            {
                List<BestPriceAlertDto>? alerts = await _httpClient.GetFromJsonAsync<List<BestPriceAlertDto>>("/api/prices/best-price-alerts");
                return alerts ?? [];
            }
            catch
            {
        ...
        public async Task<List<StorePreferenceDto>> GetStorePreferencesAsync()
        {
            ...
            try
            {
                List<StorePreferenceDto>? prefs = await _httpClient.GetFromJsonAsync<List<StorePreferenceDto>>("/api/prices/store-preferences");
                return prefs ?? [];
            }
            catch
            {
        ...
        public async Task<bool> UpdateStorePreferenceAsync(UpdateStorePreferenceRequest request)
        {
            ...
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/prices/store-preferences", request);
                return response.IsSuccessStatusCode;
            }
            catch
            {
        ...
        public async Task<List<PriceTrendDto>> GetPriceTrendsAsync(GetPriceTrendsRequest request)
        {
            try
            {
                HttpResponseMessage response = await _httpClient.PostAsJsonAsync("/api/prices/trends", request);
                response.EnsureSuccessStatusCode();
                List<PriceTrendDto>? trends = await response.Content.ReadFromJsonAsync<List<PriceTrendDto>>();
                return trends ?? [];
            }
            catch
            {
